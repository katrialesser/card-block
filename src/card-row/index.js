...
const FONT_SIZES = [
  { name: 'small',    shortName: 'S',   size: 16 },
  { name: 'regular',  shortName: 'M',   size: 18 },
  { name: 'large',    shortName: 'L',   size: 40 },
  { name: 'larger',   shortName: 'XL',  size: 60 },
];
...
export const settings = {
  title: __('Katria Block'),

  description: __('A custom katria block for Gutenberg Cloud'),
